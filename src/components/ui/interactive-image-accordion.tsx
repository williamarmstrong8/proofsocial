...
export function LandingAccordionItem() {
  ...
  return (
    <div className="bg-[#050505] font-sans">
      <section className="container mx-auto px-4 py-12 md:py-24" data-scroll-section>
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <div className="mt-8">
              <a
                href="#contact"
                className="inline-block bg-[#3A86FF] text-white font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-[#2d6bcc] transition-colors duration-300"
              >
                Contact Us
              </a>
            </div>
